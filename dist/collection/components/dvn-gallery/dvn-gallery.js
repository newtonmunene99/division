...
export class DvnGallery {
    ...
    render() {
        return [
            h("div", null, !this.src && !this.images ? (h("div", null)) : (h("div", { id: "photos", style: { 'background-color': this.color, overflow: 'auto' } }, this.src
                ? this.images.map((image, index) => (h("dvn-image", { src: image, alt: "Image", onClick: event => {
                        this.handleImageOpen(event, index);
                    } })))
                : this.images.map((image, index) => (h("dvn-image", { src: image.src, alt: "Image", onClick: event => {
                        this.handleImageOpen(event, index);
                    } })))))),
            h("div", null, this.preview ? (h("div", { id: "galleryPreview" },
                h("div", { class: "body" },
                    ...
                    h("dvn-image", { src: this.CurrentImageUrl, alt: "Image" })),
    ...
    static get is() { return "dvn-gallery"; }
    ...
    static get style() { return "/**style-placeholder:dvn-gallery:**/"; }
}
